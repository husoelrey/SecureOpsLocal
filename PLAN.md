...
- [ ] Verify Docker Desktop, Ollama, and Foundry Local versions and service health.
- [ ] Acquire the Foundation-Sec GGUF outside the repository, verify it, and record its SHA-256.
